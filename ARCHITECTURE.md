...
- **Backend boundaries:** Next handlers proxy news; Supabase owns likes and LAN Realtime signaling; EdgeOne owns the public encrypted relay and its cleanup schedule.
...
- **News:** read `src/lib/news.ts` and both route handlers before editing a news page.
