...
14. Voice uses browser `MediaRecorder` to create a voice-message attachment. It is not a realtime voice call feature. Voice attachments are automatically cached as browser object URLs and rendered as playable chat bubbles.
