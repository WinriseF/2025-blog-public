			...
			<div className='grid w-full gap-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center'>
				<section>
					...
					<p className='text-secondary mt-5 max-w-xl text-base leading-8'>
						在浏览器里审阅本机 Git 历史、工作区和任意版本差异。Agent 只在本机回环地址工作，仓库读取保持只读。
					</p>
					...
					{!supported ? (
						...
						<div className='relative'>
							<div className='flex items-center justify-between'>
								<span className='text-secondary font-mono text-xs'>WINRISEF AGENT / VC V1</span>
							...
							<p className='text-secondary mt-3 min-h-12 leading-6'>
								{connected ? '现在由系统目录选择器授权一个 Git 项目。' : '同一个便携 EXE 会按功能启动；此模式不会开启局域网服务或申请防火墙权限。'}
							</p>
							{error && (
							...
							<button
								...
								{connected ? '选择 Git 项目' : '启动并连接 Agent'}
							</button>
